...
// Test setup helper
func setupFacadeTest() (*facade.Facade, *MockAuthClient, *MockItemsClient, *MockPasswordClient, *MockMetaClient, *MockNoteClient, *MockCardClient, *MockBinaryClient) {
	...
	f := facade.NewFacadeWithOptions(facade.FacadeOptions{
		AuthClient:     authMock,
	...
	return f, authMock, itemsMock, passMock, metaMock, noteMock, cardMock, binaryMock
}

// Test cases

func TestFacade_Login(t *testing.T) {
	f, authMock, _, _, _, _, _, _ := setupFacadeTest()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			authMock.On("Login", tt.username, tt.password).Return(tt.mockErr).Once()

			err := f.Login(tt.username, tt.password)
...
func TestFacade_Register(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			key, err := f.Register(tt.username, tt.password, tt.email)
...
func TestFacade_GetItems(t *testing.T) {
	f, _, itemsMock, _, _, _, _, _ := setupFacadeTest()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			resultItems, resultTotal, err := f.GetItems(ctx, page, pageSize)
...
func TestFacade_PasswordOperations(t *testing.T) {
	f, _, _, passMock, _, _, _, _ := setupFacadeTest()
	ctx := context.Background()
	now := time.Now()
	...
	t.Run("StorePassword success", func(t *testing.T) {
		...
		id, err := f.StorePassword(ctx, "user1", "pass1")
	...
	t.Run("GetPassword success", func(t *testing.T) {
		...
		pass, updated, err := f.GetPassword(ctx, "pass-123")
		require.NoError(t, err)
	...
	t.Run("UpdatePassword success", func(t *testing.T) {
		...
		err := f.UpdatePassword(ctx, "pass-123", "user1", "newpass")
		require.NoError(t, err)
		passMock.AssertExpectations(t)
	})
	...
	t.Run("DeletePassword success", func(t *testing.T) {
		...
		deleted, err := f.DeletePassword(ctx, "pass-123")
		require.NoError(t, err)
...
func TestFacade_MetaOperations(t *testing.T) {
	f, _, _, _, metaMock, _, _, _ := setupFacadeTest()
	ctx := context.Background()
	...
	t.Run("GetMetainfo success", func(t *testing.T) {
		...
		result, err := f.GetMetainfo(ctx, "item-123")
		require.NoError(t, err)
	...
	t.Run("SetMetainfo success", func(t *testing.T) {
		...
		success, err := f.SetMetainfo(ctx, "item-123", meta)
		require.NoError(t, err)
	...
	t.Run("DeleteMetainfo success", func(t *testing.T) {
		...
		success, err := f.DeleteMetainfo(ctx, "item-123", "key1")
		require.NoError(t, err)
		assert.True(t, success)
		metaMock.AssertExpectations(t)
	})
...
func TestFacade_NoteOperations(t *testing.T) {
	f, _, _, _, _, noteMock, _, _ := setupFacadeTest()
	ctx := context.Background()
	now := time.Now()
	...
	t.Run("StoreNote success", func(t *testing.T) {
		...
		id, err := f.StoreNote(ctx, "test content")
		require.NoError(t, err)
	...
	t.Run("GetNote success", func(t *testing.T) {
		...
		note, updated, err := f.GetNote(ctx, "note-123")
		require.NoError(t, err)
	...
	t.Run("DeleteNote success", func(t *testing.T) {
		...
		deleted, err := f.DeleteNote(ctx, "note-123")
		require.NoError(t, err)
		assert.True(t, deleted)
		noteMock.AssertExpectations(t)
	})
...
func TestFacade_CardOperations(t *testing.T) {
	f, _, _, _, _, _, cardMock, _ := setupFacadeTest()
	ctx := context.Background()
	now := time.Now()
	...
	t.Run("StoreCard success", func(t *testing.T) {
		...
		id, err := f.StoreCard(ctx, "4111111111111111", "12/25", "123", "John Doe")
		require.NoError(t, err)
	...
	t.Run("GetCard success", func(t *testing.T) {
		...
		card, updated, err := f.GetCard(ctx, "card-123")
		require.NoError(t, err)
	...
	t.Run("UpdateCard success", func(t *testing.T) {
		...
		err := f.UpdateCard(ctx, "card-123", "4111111111111111", "12/26", "456", "John Doe")
		require.NoError(t, err)
		cardMock.AssertExpectations(t)
	})
	...
	t.Run("DeleteCard success", func(t *testing.T) {
		...
		deleted, err := f.DeleteCard(ctx, "card-123")
		require.NoError(t, err)
		assert.True(t, deleted)
		cardMock.AssertExpectations(t)
	})
...
func TestFacade_BinaryOperations(t *testing.T) {
	f, _, _, _, _, _, _, binaryMock := setupFacadeTest()
	ctx := context.Background()
	...
	t.Run("UploadBinary success", func(t *testing.T) {
		...
		id, err := f.UploadBinary(ctx, "test.txt", reader)
		require.NoError(t, err)
	...
	t.Run("DownloadBinary success", func(t *testing.T) {
		...
		err := f.DownloadBinary(ctx, "file-123", writer)
		require.NoError(t, err)
		binaryMock.AssertExpectations(t)
	})
	...
	t.Run("GetFile success", func(t *testing.T) {
		...
		file, err := f.GetFile(ctx, "file-123")
		require.NoError(t, err)
	...
	t.Run("DeleteBinary success", func(t *testing.T) {
		...
		deleted, err := f.DeleteBinary(ctx, "file-123")
		require.NoError(t, err)
		assert.True(t, deleted)
		binaryMock.AssertExpectations(t)
	})
