...
func request_FileService_GetFiles_0(ctx context.Context, marshaler runtime.Marshaler, client FileServiceClient, req *http.Request, pathParams map[string]string) (FileService_GetFilesClient, runtime.ServerMetadata, error) {
	var (
	...
	stream, err := client.GetFiles(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func RegisterFileServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileServiceClient) error {
	...
	mux.Handle(http.MethodPost, pattern_FileService_GetFiles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_FileService_GetFiles_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodPost, pattern_FileService_DownloadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
...
var (
	...
	forward_FileService_GetFiles_0     = runtime.ForwardResponseStream
